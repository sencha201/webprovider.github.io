                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="registration.php"><i class="fas fa-tools"></i> Service Provider</a></li>
                    </ul>
                  </div>
                </nav>
              </div>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="new.php" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <h5><label class="font-weight-bold" for="email"><i class="fas fa-envelope-open"></i> Username</label><h5>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <a href="registration.php" class="btn btn-primary pill px-4 py-2">Don't have an account ? Register</a>
                </div>
              </div>
