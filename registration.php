        ...
        <div class="row">
          ...
          if(isset($_POST['submit']))
          {
            ...
            $query="INSERT INTO `registration`
	          (`name`, `mobile`, `email`, `password`, `city`, `address`, `experience`, `id_proof`, `id_picture`, `work_type`, `picture`,`status`) 
	          VALUES ('$first','$mobile','$email','$password','$city','$address','$experience','$id_proof','$name','$work','$rname','0')";
