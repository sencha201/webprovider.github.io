...
<div class="site-wrap">
  <div class="unit-5 overlay">
    <div class="container text-center">
      <strong><h1><i class="fas fa-users"></i> Registered Users</h1></strong>
    </div>
  </div>  
<br>
...
<table class="table table-hover" style="font-size:16px">
	...
	<td><i class="fas fa-mobile"></i> Mobile no.</td>
	<td><i class="fas fa-envelope"></i> Email</td>
    <td><i class="fas fa-image"></i> Profile pic</td>
    <td><i class="fas fa-arrow-circle-right"></i> Action</td>
	</tr>
	<?php
	//include"dbconfig.php";
    ...
    <td><a href="delete_users.php?id=<?=$id?>"<button class="btn pill px-4 py-2 btn-danger del_package"><img src="images/delete-icon-14.jpg" style="height:20px;"></button></a></td>
