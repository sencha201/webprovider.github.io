...
<?php if($cancel==0 && $status==0){ ?>
  ...
  <td><a href="CancelBooking.php?bid=<?=$book_id?>"><button class="btn pill px-4 py-2 btn-danger del_package" data-status="0" onclick="if(confirm('Are you sure you want to cancel the Booking')){window.alert('Booking has been successfully cancelled');}"> <i class="fas fa-times-circle"></i> Cancel Booking</button></a></td>
				<?php }
				else if($status!=0) { ?>
