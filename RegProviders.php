...
<div class="site-wrap">
  <div class="unit-5 overlay">
    <div class="container text-center">
      <strong><h1><i class="fas fa-tools"></i> Service Providers</h1></strong>
    </div>
  </div>  
<br>
...
<table class="table table-hover" style="font-size:16px">
  ...
  <td>Id</td>
    ...
    <td><a href="delete_provider.php?id=<?=$id?>"<button class="btn pill px-4 py-2 btn-danger del_package"><img src="images/delete-icon-14.jpg" style="height:20px;"></button></a></td>
