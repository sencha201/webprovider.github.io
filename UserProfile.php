...
$query="SELECT * FROM user_registration where id=".$_SESSION['id']."";
$result=select($query);
...
<div class="site-wrap">
  <div class="unit-5 overlay">
    <div class="container text-center ">
      <strong><h1><i class="fas fa-info-circle"></i> My Profile</h1></strong>
    </div>
  </div>  
<br>
...
<table class="table table-hover" style="font-size:16px">
	...
	<td><i class="fas fa-phone-square-alt"></i> Mobile no.</td>
